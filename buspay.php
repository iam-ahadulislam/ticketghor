...
<table align="center">
<tr><td><h3>Card No.: </h3></td> <td colspan='2'><input type="Number" name="cno"  placeholder="1111-2222-3333-4444" maxlength='50' required></td></tr>
<tr><td><h3>Name on Card: </h3></td> <td colspan='2'><input type="Text" name="name" placeholder="Enter your name." maxlength='50' required></td></tr>
<tr><td><h3>Expiry Date : </h3></td> <td><input type="Number" name="Em" placeholder='MM' maxlength='2' required></td>
<td><input type="Number" name="Ey" placeholder='YY' maxlength='2' required></td></tr>
<tr><td><h3>CVV No: </td> </h3><td colspan='2'><input type="Password" name="Cvv" maxlength='3' required></td></tr>
<tr><td><h3>PIN NO: </h3> </td> <td colspan='2'><input type="Password" name="Pin" maxlength='4' required></td></tr>
...
if (isset($_POST['emergency_submit'])) {
  ...
  if (isset($_POST['emergency_pay_token']) && $_POST['emergency_pay_token'] === $_SESSION['emergency_pay_token']) {
      ...
      echo "<script>
          ...
          window.location.href = 'buspayaction.php'; // Redirect to bookdone.php
      </script>";
